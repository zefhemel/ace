...
var Document        = require("../../../../../lib/concorde/Document"),
    AceDocument      = require("../../../../../lib/concorde/AceDocument"),
...
var Test = {
    ...
    "test: insert text in line" : function() {
        var doc = new AceDocument(new Document(["12", "34"]));
    ...
    "test: delete in line" : function() {
        var doc = new AceDocument(new Document(["1234", "5678"]));
    ...
    "test: delete multi line range line" : function() {
        var doc = new AceDocument(new Document(["1234", "5678", "abcd"]));
    ...
    "test: should handle unix style new lines" : function() {
        var doc = new AceDocument(new Document(["1", "2", "3"]));
        assert.equal(doc.getValue(), ["1", "2", "3"].join("\n"));
    },

    "test: should handle windows style new lines" : function() {
        var doc = new AceDocument(new Document(["1", "2", "3"].join("\r\n")));
    ...
    "test: set value": function() {
        var doc = new AceDocument(new Document("1"));
    ...
    "test: empty document has to contain one line": function() {
        var doc = new AceDocument(new Document(""));
